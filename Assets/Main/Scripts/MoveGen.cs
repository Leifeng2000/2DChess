...
public static class MoveGen {
	...
	public static int GenerateMoves(Board board, SMove[] moves, int StartAt = 0, int depth = 0) {
		...
		if (board.SideToPlay == 1)
        {
            ...
            {
                if ((Occupancy & 0x6000000000000000) == 0)
                {
                    if (!board.IsAttacked(0x7000000000000000, 0))
                    {
            ...
            {
                if ((Occupancy & 0xe00000000000000) == 0)
                {
                    if (!board.IsAttacked(0x1c00000000000000, 0))
                    {
            ...
            while (Knights != 0)
            {
                ...
                ulong Moves = KnightAttacksDatabase[From] & ~board.WOcc;
            ...
            while (Bishops != 0)
            {
                ...
                ulong Moves = BishopAttack(From, Occupancy) & ~board.WOcc;
            ...
            while (Rooks != 0)
            {
                ...
                ulong Moves = RookAttack(From, Occupancy) & ~board.WOcc;
                while (Moves != 0)
                {
                    int To = Ops.PopFirstBit(ref Moves);
                    int capturePiece = pieces[To];
            ...
            while (Queens != 0)
            {
                ...
                ulong Moves = (BishopAttack(From, Occupancy) | RookAttack(From, Occupancy)) & ~board.WOcc;
            ...
            while (King != 0)
            {
                ...
                ulong Moves = KingAttacksDatabase[From] & ~board.WOcc;
            ...
            while (Knights != 0)
            {
                ...
                int From = Ops.FirstBit(Knights);
                Knights ^= Ops.Pow2[From];
                ulong Moves = KnightAttacksDatabase[From] & ~board.BOcc;
            ...
            while (Bishops != 0)
            {
                ...
                int From = Ops.FirstBit(Bishops);
                Bishops ^= Ops.Pow2[From];
                ulong Moves = BishopAttack(From, Occupancy) & ~board.BOcc;
            ...
            while (Rooks != 0)
            {
                ...
                int From = Ops.FirstBit(Rooks);
                Rooks ^= Ops.Pow2[From];
                ulong Moves = RookAttack(From, Occupancy) & ~board.BOcc;
            ...
            while (Queens != 0)
            {
                ...
                int From = Ops.FirstBit(Queens);
                Queens ^= Ops.Pow2[From];
                ulong Moves = (BishopAttack(From, Occupancy) | RookAttack(From, Occupancy)) & ~board.BOcc;
            ...
            while (King != 0)
            {
                ...
                ulong Moves = KingAttacksDatabase[From] & ~board.BOcc;
